...
print(f"  ✓ Old DataLoader data (first 5x3):")
print(result_old.isel(time=slice(0, 5), asset=slice(0, 3)).values)
...
print(f"  ✓ New DataSource data (first 5x3):")
print(result_new.isel(time=slice(0, 5), asset=slice(0, 3)).values)
